...
var LayerManager = Class.extend(
    ...
    refreshMaxDimensions: function (type) {
        let old = this._maxLayerDimensions;
        let maxWidth = 0;
        let maxHeight = 0;
        ...
        $.each(this._layers, function () {
            ...
            maxWidth = Math.max(maxWidth, d.right - d.left);
            maxHeight = Math.max(maxHeight, d.bottom - d.top);

        });

        this._maxLayerDimensions = {width: maxWidth, height: maxHeight};

	...
	<div style="width: 100%; height: 100%; margin: 0; padding: 0;">
		...
		<div id="hv-header" class="user-select-none">
			...
			<div id="logo">
				<h1>
					<span>
						<a class="logo-icon fa fa-sun-o fa-fw" href="" title="The Open-Source Solar and Heliospheric Data Browser"></a><a class="logo-text" href="" title="The Open-Source Solar and Heliospheric Data Browser">Helioviewer</a>
						<a id='help-links-changelog' rel="/dialogs/changelog.php" href="#"><img style="width: 60px; vertical-align: middle;" src="/resources/images/beta_tape_label1.png"/></a>
					</span>
				</h1>
			</div>
